...
require (
	...
	github.com/whosonfirst/go-whosonfirst-spatial v0.0.15
	github.com/whosonfirst/go-whosonfirst-spatial-http v0.0.9
	github.com/whosonfirst/go-whosonfirst-spatial-sqlite v0.0.13
