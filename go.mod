...
require (
	...
	github.com/whosonfirst/go-whosonfirst-spatial v0.0.22
	github.com/whosonfirst/go-whosonfirst-spatial-http v0.0.14
	github.com/whosonfirst/go-whosonfirst-spatial-sqlite v0.0.16
